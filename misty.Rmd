...
g = plot_interaction_communities2(misty_results[[1]], view='intra')
...
# TODO:
# * Remove outlier
# * Map molecule classes/names
# * Quantify differences between stronly intra and strongly para lipids
```
